...
def show(friend_id):
    #Write query to show specific users by ID. At every point where you
    #want to insert data, write ":" and variable name
    query = "SELECT * FROM friends WHERE id = :specific_id"
    #then define a dictionary with the key the matches :variable_name in query
